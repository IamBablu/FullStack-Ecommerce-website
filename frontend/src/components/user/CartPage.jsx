...
const CartPage = () => {
  const { serverUrl, cart, setCart, editToCartGlobal, loading, userdata } = useContext(userDataContext)
                  ...
                  <div className='flex gap-5'>
                    ...
                    <div>
                      ...
                      <p className='flex gap-4 mt-3'>
                        <button className='bg-blue-700 p-2 text-xs rounded hover:scale-105 active:scale-95 transition cursor-pointer' onClick={() => { navigate('/checkout-page', { state: { product: item, quantity: currQuantity } }) }}>Checkout this Product</button>

                    ...
                    <div className='flex items-center justify-between h-20'>
                        ...
                        >
                            ...
                            <div className='hidden md:block'>
                                <motion.h1 
                                    className='text-2xl font-black bg-linear-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent'
                                    animate={{ 
                        ...
                        >
                            <h2 className='text-xl font-semibold bg-linear-to-r from-red-500 via-purple-500 to-blue-500 bg-clip-text text-transparent'>
                ...
                {isMobileMenuOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className='fixed left-0 top-0 bottom-0 w-80 bg-linear-to-b from-gray-900 to-gray-800 z-50 shadow-2xl md:hidden'
                        >
                            <div className='p-6 h-full flex flex-col'>
                                <div className='flex items-center gap-3 mb-8 pb-4 border-b border-gray-700'>
                                    <div className='relative'>
                                        <div className='absolute inset-0 bg-linear-to-r from-blue-500 to-purple-500 rounded-full blur-md'></div>
                                ...
                                <div className='lg:hidden'>
                                    <Sidebar action={setIsMobileMenuOpen}/>
                                </div>
                                </div>
                                <div className='pt-4 border-t border-gray-700'>
                                    <button
                                        ...
                                        className='w-full mb-3 py-3 bg-linear-to-r from-blue-600 to-purple-600 rounded-xl font-semibold text-white hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 active:scale-95'
                                    >
                                        Profile Settings
                                    </button>
                                    <button
...
const Icon = ({ icon, onClick, css = '' }) => {
    return (
        <motion.div 
            whileHover={{ scale: 1.1, rotate: 5 }}
            whileTap={{ scale: 0.9 }}
            className={`${css} text-3xl bg-linear-to-r from-gray-600 to-gray-700 rounded-full p-2 cursor-pointer hover:from-gray-700 hover:to-gray-800 shadow-lg hover:shadow-blue-500/30 transition-all duration-300`} 
            onClick={onClick}
        >
            {icon}
        </motion.div>

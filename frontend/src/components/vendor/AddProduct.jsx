                ...
                >
                    ...
                    <div className="text-center mb-8">
                        <motion.h1
                            initial={{ scale: 0.9 }}
                            animate={{ scale: 1 }}
                            className="text-4xl font-bold bg-linear-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent"
                        >
                            Add New Product
                        </motion.h1>
                        ...
                        <form onSubmit={handleSubmit} className="p-6 space-y-6">
                                            ...
                                            {availableSize.map((size) => {
                                                ...
                                                return (
                                                    <motion.button
                                                        ...
                                                        className={`px-4 py-2 rounded-lg font-semibold transition-all duration-200 ${isSelected
                            ...
                            <div className="space-y-4">
                                ...
                                <div className='flex flex-col sm:flex-row gap-2'>
                                    ...
                                    <button
                                        ...
                                        className='px-6 py-2 bg-linear-to-r from-blue-600 to-indigo-600 rounded-lg cursor-pointer hover:from-blue-700 hover:to-indigo-700 transition-all flex items-center gap-2 justify-center'
                                    >
                            ...
                            <div className="flex gap-3 pt-4">
                                ...
                                <button
                                    type='submit'
                                    disabled={loading}
                                    className='cursor-pointer flex-1 px-6 py-3 bg-linear-to-r from-blue-600 to-indigo-600 rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed'
                                >
                                    {loading ? (
                                ...
                                >
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            disabled={loading}
                                            className='w-full flex-1 px-6 py-3 bg-linear-to-r from-blue-600 to-indigo-600 rounded-lg font-semibold cursor-pointer hover:from-blue-700 hover:to-indigo-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed '
                                        >
                                            {loading ? (
                                                <div className="flex items-center justify-center gap-2">
                                                    <div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div>

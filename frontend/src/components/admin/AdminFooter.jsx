  ...
  return (
    ...
    className='bg-gray-800'>
      ...
      <ul>
        ...
        <button className='p-2 rounded-full text-xl bg-blue-700 px-4 my-6 hover:bg-blue-900 shadow-lg hover:shadow-gray-500 cursor-pointer transition-all duration-300 border-white border-2'>Admin Panel</button>

      </ul>
      <ul className='border-2 border-gray-500 rounded-2xl p-4 bg-gray-600/30 hover:shadow-blue-600 shadow-xl'>
        <li className='text-2xl font-semibold'>System Access</li>
        <li className='my-2'><a href="/" className='hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-blue-700'>&#x2714; Platform Management</a></li>
        <li className='my-2'><a href="/" className='hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-blue-700'>&#x2714; Vendor Control</a></li>
        <li className='my-2'><a href="/" className='hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-blue-700'>&#x2714; Orders & Revenue</a></li>
        <li className='my-2'><a href="/" className='hover:underline hover:underline-offset-4 hover:decoration-2 hover:decoration-blue-700'>&#x2714; System Security</a></li>
      </ul>
      <ul>

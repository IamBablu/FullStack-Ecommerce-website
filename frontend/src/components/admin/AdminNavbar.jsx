            ...
            >
                <div className='container mx-auto px-4'>
                    <div className='flex items-center justify-between h-20'>
                        ...
                        >
                            <h2 className='text-2xl font-black bg-gradient-to-r from-red-500 via-purple-500 to-blue-500 bg-clip-text text-transparent'>
                                WELCOME TO MY CART
                            </h2>
                        </motion.div>
                        ...
                        >
                            ...
                            <div className='p-5 space-y-4 max-h-96 overflow-y-auto custom-scrollbar'>
                                ...
                                <button
                                    ...
                                    className='w-full py-2 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl font-medium text-white hover:from-green-700 hover:to-emerald-700 transition-all duration-300 transform hover:scale-105 active:scale-95'
                                >
                                    Update Avatar
                                </button>
                ...
                <AnimatePresence>
                    {openMenu && (
                        <motion.div 
                            ...
                            transition={{ duration: 0.3, type: "spring" }}
                            className='fixed left-0 top-20 bottom-0 w-80 bg-gradient-to-b from-gray-800 to-gray-900 shadow-2xl z-20 md:hidden overflow-y-auto'
                        >
                            <div className='p-6'>
                                <Sidebar 
                                ...
                                <button
                                    ...
                                    className='w-full mt-4 py-3 bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl font-medium text-white hover:from-green-700 hover:to-emerald-700 transition-all duration-300'
                                >
                                    Update Avatar
                                </button>
                            </div>

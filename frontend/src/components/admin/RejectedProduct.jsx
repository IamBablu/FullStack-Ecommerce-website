    ...
    return (
        <div>
            <div className='bg-gray-800 h-[95%] w-[95%] rounded-4xl overflow-y-scroll [&::-webkit-scrollbar]:w-0 px-10 py-4'>
                <h1 className='text-4xl font-semibold mb-5 text-red-600'>Rejected Product</h1>
                ...
                <div className='bg-black w-[60%] rounded-2xl text-white p-8 flex flex-col gap-5 text-lg relative'>
                    ...
                    <div className='flex gap-10 pr-10 text-center'>
                        ...
                        <div className='w-full'>
                            ...
                            <p className='text-red-500'>{selectedProduct.title}</p>
                        </div>
                    </div>
                    <div className='flex justify-around'>
                        ...
                        <div>
                            ...
                            <p className='text-red-500'>{selectedProduct.verificationStatus}</p>
                        </div>
                        <div>
                            <p className='text-xl font-semibold'>Category</p>
                            <p className='text-red-500'>{selectedProduct.category}</p>
                        </div>
                    </div>
                    <div className='flex justify-around'>
                    <p><span className='text-xl font-semibold'>Description:</span> <br /> <span className='ml-5 font-normal text-red-500'>{selectedProduct.description}</span></p>
                    <p><span className='text-xl font-semibold'>Rejected Reason:</span> <br /> <span className='ml-5 font-normal text-red-500'>{selectedProduct.rejectedReason}</span></p>
